...
You can use this code only for research purpose *with no support*. I don't remember its contents because I created this code about 17-18 years ago.

Now I've succeeded to compile this code on Fedora 24 linux.
To compile this code, you have to install the following library by using dnf.
