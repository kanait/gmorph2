...
#define EDIT_LOOP       0
#define EDIT_DEL_LOOP   1
#define EDIT_FACE       2
#define EDIT_DEL_FACE   3
#define EDIT_HPOINT     4
#define EDIT_MOV_HPOINT 5
#define EDIT_DEL_HPOINT 6
#define EDIT_HFACE      7
#define EDIT_DEL_HFACE  8
#define EDIT_SPATH      9
#define EDIT_DEL_SPATH  10
#define EDIT_SPATH_MANU 11
#define EDIT_NONE       12
...
typedef struct _swin {
  ...
  unsigned short filed;                  /* file flag (decide *.<***>) */
  unsigned short opend;                  /* file open flag (0 : open 1 : save) */
