...
void init_gl3d(ScreenAtr *screen)
{
  Light default_light =  {
    ...
    /*{0.4, 0.4, 0.4, 1.0},*/	/* diffuse */ /* for fig */
    {1.0, 1.0, 1.0, 1.0},	/* diffuse */
    {1.0, 1.0, 1.0, 1.0},	/* specular */
    {100.0, 100.0, 100.0, 0.0},	/* position */
    /*{0.3, 0.3, 0.3, 1.0},*/	/* lmodel_ambient */ /* for fig */
    {1.0, 1.0, 1.0, 1.0},	/* lmodel_ambient */
    {0.0}};			/* local view */
  int   makerasterfont(ScreenAtr *, char *);
...
/*     } else drawppd_edge( ppd, screen ); */
  ...
  if ( swin->view_attribs == VIEW_INTPMESH ) return;
  
  if ( swin->dis3d.loop ) {
    
    if ( swin->ext_display == SMD_OFF ) {
...
static void draws3d( ScreenAtr *screen )
{
  void drawppd_sged( SGraph *, ScreenAtr *, GLdouble *, GLfloat );
  void draw_sglp( SGlp * );
